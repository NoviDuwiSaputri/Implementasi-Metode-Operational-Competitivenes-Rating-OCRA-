			...
			<div class="col-lg-9 p-3">
				<div class="row">
					...
					<div class="col-lg-6 col-sm-12 p-4">						
						<a href="hasil_rekom.php">
							<button class="btn btn-outline-primary">
                                <h1>Hasil Rekomendasi</h1>
                                <p class="text-center">Perankingan Objek Wisata Rekomendasi dengan metode OCRA</p>
                            </button>
						</a>
					</div>
					<div class="col-lg-6 col-sm-12 p-4">						
						<a href="kuesioner.php">
							<button class="btn btn-outline-success">
                                <h1>Kuesioner</h1>
                                <p class="text-center">Silahkan megisi kuesioner setelah anda mengunjungi Objek Wisata!</p>
                            </button>
						</a>
					</div>							
				</div>
