        ...
        <div class="row" style="padding-top: 80px; padding-bottom: 20px;">			
			<div class="col-lg-12 p-3">
				<div class="row">
					...
					<div class="col-lg-12">
						<h3 class="text-center">SELAMAT DATANG ! Dihalaman Kuesioner</h3>
						<hr>
					</div>
					
					<div class="col-lg-12">
					<p>Silahkan pilih keusioner dibawah ini:</p>
						<table class="table text-center table-striped table-hover table-bordered table-responsive" id="data-table">
							<thead>
								<tr>
									<td><strong>No</strong></td>
									<td><strong>Wisata</strong></td>
									<td><strong>Isi Kuesioner</strong></td>
								</tr>
							</thead>					
							<tbody>
							...
							?>
								<tr>
									...
									<td class="text-center">
										<a class="btn btn-success btn-sm" href='isi.php?id=<?php echo $row['id_objek']; ?>'><i class="fa fa-edit"></i></a>						
									</td>
								</tr>
							<?php
								}
