			...
			<div class="col-lg-12 p-3">
				<div class="row">
					...
					<div class="row">
						...
						<div class="col-lg-1">
							<button type="submit" class="btn btn-primary" name="cek" id="cek">Filter</button>
						</div>
					</div>
					</form><br><br>
					<?php
					...
					<?php
						...
						function cek(){
							...
							if(isset($_POST['cek'])){
								...
								?>
								<h3 class="text-center">Hasil Rekomendasi <?php echo "Bulan ".$Bulan." Tahun ".$Tahun; ?></h3><br><br>
								<form action="" id="form" method="post" enctype="multipart/form-data">
								...
								<thead>
									<tr>
										...
										<td><strong>Total OCRA</strong></td>
								...
								if (mysqli_num_rows($user) > 0){
									...
									<tr>
										...
										<td><a href='detail.php?id=<?php echo $row['id_objek']; ?>'><?php echo $row['ket']; ?></a></td>
