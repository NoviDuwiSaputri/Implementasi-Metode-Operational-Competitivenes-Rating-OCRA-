        ...
        <div class="row" style="padding-top: 80px; padding-bottom: 20px;">			
			<div class="col-lg-9 p-3">
				<div class="row">
					...
					<div class="col-lg-12">
						<h3> Objek Wisata Alam Yogyakarta</h3>
						<hr>
					</div>
					...
					$sql = "SELECT * FROM objek_wisata WHERE id_objek";
					...
					?>	
						<div class="row">
							...
							<div class="col-lg-8">
								...
								<p>Wisata Alam</p>
								<a href="detail.php?id=<?php echo $row['id_objek']; ?>" class="btn btn-outline-primary">Lihat Detail&nbsp;&nbsp;<i class="fa fa-arrow-circle-right"></i></a>
								<br><br><br>
								<p class="text-end" ><i><small >Created : <?php echo $row['tgl']; ?></small></i></p>
							</div>
						</div>
						<hr>
					<?php
